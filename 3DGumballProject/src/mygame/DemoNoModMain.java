...
public class DemoNoModMain extends SimpleApplication { 
  public static void main(String args[]) {
    DemoNoModMain app = new DemoNoModMain();
    app.start();
  ...
  public void simpleInitApp() {
    ...
    cam.setLocation(new Vector3f(0, 3f, 18f));
  ...
  protected void makeGumballMachine() {
    ...
    Spatial gM = makeCube("Gumball Machine", 0, 0, 1f);
